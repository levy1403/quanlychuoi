...
import {
  useRouter,
  useRouterState
} from "./chunk-URRIPQNO.js";
import "./chunk-TX3JUV4G.js";
import {
  require_jsx_runtime
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component)) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-2LFVXJYN.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet2(this, _Component2)) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-ZOXNXIID.js"));
